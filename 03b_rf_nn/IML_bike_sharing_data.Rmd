...
day_selected <- bikes2[,c(4:15,17,18)]
head(day_selected)

I.train <- sort( sample(1:dim(day_selected)[1],500,replace=FALSE) )
...
# x axis is every possible possible value of splits
...
aux <- which(day[I.train,2]=="2012-10-05")
