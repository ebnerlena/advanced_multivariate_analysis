...
# starting with basis of degree 7
...
# regression spline with degree 0 without penalty
``` 
...
# using basis of b-spline of degree 1
# with linear combinations of breakes in the knots in triangular lines
# not so flexible because lower number of knots and heigher penalty
# polygonial line
# 
```
...
# put a lot of knots it is catching all variability (left top)
# (left bottom) 7 degree of freedom
# still no penalty - only regression
```
