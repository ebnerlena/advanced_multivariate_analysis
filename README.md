...
- [Density Estimation Example Code](./01a_density_estimation/)
- [Density Estimation Assignment](./01_assignment/)
- [Clustering Example Code](./01b_clustering/)
- [Clustering Assignment](./02_assignment/)
- [Non Linear Dimensionality Reduction](./01d_nonlinear_dimensionality_reduction/)
- [ISOMAP](./01d_isomap/)
- [Local MDS](./01d_local_mds/)
- [Principal Curves](./01d_principal_curves/)
- [t-SNE](./03_t-SNE/)
