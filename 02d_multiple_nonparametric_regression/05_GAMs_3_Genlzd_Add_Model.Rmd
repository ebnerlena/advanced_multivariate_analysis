...
am1.6 <- gam(Inf.Mort.rat ~ Agric.employ.. + Life.expec +
               ti(Agric.employ..,Life.expec), # interaction term between those 2 variables
             data=countries)
summary(am1.6)
...
# null hypthesis is that the simpler model am1.o is sufficient and the more complex model does not significant improve fit
# if p-value is less then 0.05 we would reject null hypothesis
# a small p-value suggest that the more complex model significantly improes the fit
# df -> differences in number of parameters for both models
# higher df means a more complex model
```
