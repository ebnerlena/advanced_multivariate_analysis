...
* `Inf.Mort.rat ~ Agric.employ.. + Life.expec`
* `Inf.Mort.rat ~ s(Agric.employ..) + s(Life.expec)`
* `Inf.Mort.rat ~ s(Agric.employ..,by=ind.le) + s(Life.expec,by=ind.agr)`
...
vis.gam(am1.4,view=c("Agric.employ..","Life.expec"),
        theta = 40, phi = 25, r = sqrt(3), d = 1,)
```
...
Then choose the model (or models) that you consider *the best*.
